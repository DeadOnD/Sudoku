 ...
 * <p>
 * The author had to rename the package 'com.admob.advancesudoku' in 'com.googlecode.ansudoku'
 * because app package names have to be unique. As a consequence the database became incompatible
 * with Andoku's because it contained Serializable objects and the class names have changed.
 * <p>
...
class Issue30 {
	...
	public static byte[] workaround(byte[] serializable) {
		...
		return replace(serializable, "com.googlecode.ansudoku.model.AndokuPuzzle$PuzzleMemento",
				"com.admob.advancesudoku.model.AndokuPuzzle$PuzzleMemento");
	}
